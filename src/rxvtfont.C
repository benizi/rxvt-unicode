                         ...
                         int fg, int bg)
{
  ...
  //fprintf(stderr, "TODO:%s:%d [fg=%08x pixel=%016lx]\n", __FILE__, __LINE__, fg, xft_fg.pixel);
#else
...
#ifdef USE_24_BIT_COLOR
          {
            if(bg >= 0)
            ...
            else
              {
                ...
                //fprintf(stderr, "TODO:%s:%d [bg (<=0) %d]\n", __FILE__, __LINE__, bg);
              }
          }
#else
