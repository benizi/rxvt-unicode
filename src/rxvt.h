...
// fake styles
#define RS_blinkShift (RS_styleShift + 2)
#define RS_Blink                ((rend_t)(1UL << (RS_blinkShift + 0)))
#define RS_RVid                 ((rend_t)(1UL << (RS_blinkShift + 1)))    // reverse video
#define RS_Uline                ((rend_t)(1UL << (RS_blinkShift + 2)))    // underline
...
#define GET_BGATTR(x)                                      \
  (ecb_unlikely (((rend_t)x) & RS_RVid)                            \
    ? ((((rend_t)x) & (RS_attrMask & ~((rend_t)RS_RVid)))                    \
      | ((((rend_t)x) & RS_fgMask) >> (RS_fgShift - RS_bgShift)))  \
    : (((rend_t)x) & (RS_attrMask | RS_bgMask)))
